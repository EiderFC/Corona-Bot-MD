...
### `—◉ 💰 DONAR 💰`
- AGRADECE CON UNA DONACION VOLUNTARIA [Aqui](https://www.paypal.me/Cuarentenadefrikis)
...
[![Run on Repl.it](https://repl.it/badge/github/EiderFC/Corona-Bot-MD)](https://repl.it/github.com/EiderFC/Corona-Bot-MD)

### `—◉ ✨ ACTIVAR EN HEROKU ✨`
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/EiderFC/Corona-Bot-MD)
```bash
...
### `—◉ ⚙️ AJUSTES ⚙️`
- CLONAR EL REPOSITORIO [Aqui](https://github.com/EiderFC/Corona-Bot-MD/fork)
- CAMBIAR NÚMERO DEL OWNER [Aqui](https://github.com/EiderFC/Corona-Bot-MD/blob/master/config.js)
...
> pkg install yarn
> git clone https://github.com/EiderFC/Corona-Bot-MD
> cd Corona-Bot-MD
> yarn install 
> npm update
> npm start
...
- EIDERFC NO SE HACE RESPONSABLE DEL USO, NUMEROS, PRIVACIDAD Y CONTENIDO MANDADO, USADO O GESTIONADO POR USTEDES O EL BOT
```

## `EDITOR Y PORPIETARIO DEL BOT` 
<a href="https://github.com/EiderFC"><img src="https://github.com/EiderFC.png" width="300" height="300" alt="EiderFC"/></a>

`Corona-Bot-MD _ By EiderFC`
