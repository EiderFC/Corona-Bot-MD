...
let str = `
*ミ💖 𝙷𝙾𝙻𝙰 ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 CORONA - 𝙱𝙾𝚃 💖彡*

*Grupo Principal del Bot:* https://chat.whatsapp.com/BpBbWjCpWpL0cdUIvwZyqW
...
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'https://paypal.me/CuarentenaDeFrikis', '𝙿𝙰𝚈𝙿𝙰𝙻', 'https://discord.com/invite/Mz4rxjw', 'DISCORD', [
['📮 𝙳𝙾𝙽𝙰𝚁 📮', '/donasi'],
['🌹 𝙾𝚆𝙽𝙴𝚁 🌹', '/owner'],
['🐾 𝙸𝙽𝙵𝙾𝙱𝙾𝚃 🐾', '/infobot']
], m,)
